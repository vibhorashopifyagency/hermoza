class CollectionFiltersForm extends HTMLElement {
    ...
    static resizeGridItem(item) {
        grid = document.getElementsByClassName('scoder-row--masonry')[0];
    ...
    static renderProductGrid(html) {
        ...
        if (document.querySelector('.collection-masonry')) {
            document.getElementById('CollectionProductGrid').querySelector('.collection .scoder-row--masonry').classList.add('is-show');
