class ProductCombo extends HTMLElement {
    constructor() {
        ...
        this.querySelector('.bundle-product-wrapper').classList.remove('has-scoder-block-loader');
    ...
    onSubmitHandler(event) {
        ...
        this.querySelector('.bundle-product-wrapper').classList.add('has-scoder-block-loader');
